...
ORDER_STATUS_CART = "CART"  # Carrito creado, pendiente de pago (no visible en admin por defecto)
ORDER_STATUS_PENDING = "PENDING"  # Pago pendiente (Rapipago, transferencia, etc.)
...
# Statuses that count as "completed sales" for revenue and rankings
PAID_STATUSES = [
    ORDER_STATUS_PAID,
